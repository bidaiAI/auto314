...
**公开 MIT 仓库：** [https://github.com/bidaiAI/auto314](https://github.com/bidaiAI/auto314)

这个公开仓库仅用于**源码展示 / 参考镜像**，**不作为任何官方前端或后端部署入口**。
...
- 所有 314 发射家族：毕业前把本 token 转入 token 合约地址，会被视为向内盘卖出；普通钱包到钱包转账仍然禁止
...
- **毕业尾盘收口**：当剩余 quote 容量不超过 `0.005 native`，且协议累计的 assist reserve 足以覆盖时，合约会自动补齐最终边界并毕业，不再要求用户精确命中最后 1 wei
...
- **尾盘处理**：接近毕业时，协议会自动完成最终收口，确保向 canonical DEX 市场的切换保持确定性。
