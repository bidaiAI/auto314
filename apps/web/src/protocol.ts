...
const referenceMetadataUploadEnabled = import.meta.env.VITE_REFERENCE_METADATA_UPLOAD_ENABLED === "1";
...
export async function uploadReferenceMetadata(metadata: LaunchMetadata) {
  if (!referenceMetadataUploadEnabled) {
    throw new Error("Reference metadata upload is disabled in this deployment.");
  }
