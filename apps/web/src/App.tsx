...
const REPO_URL = "https://github.com/bidaiAI/auto314";
...
export function App() {
  ...
  async function handleUploadReferenceMetadata() {
    try {
      ...
      setStatus(
        message === "Reference metadata service is not configured."
          || message === "Reference metadata upload is disabled in this deployment."
          ? t("statusMetadataUploadUnavailable")
          : message
      );
    } finally {
      setLoading(false);
